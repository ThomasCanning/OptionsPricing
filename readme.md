...
$$
C = Discount Factor \times ( q \cdot \text{Call Value}_\text{up} + (1 - q) \cdot {Call Value}_{down})
$$

#### Put Option Price:

$$
P = Discount Factor \times ( q \cdot \text{Put Value}_\text{up} + (1 - q) \cdot \text{Put Value})
$$